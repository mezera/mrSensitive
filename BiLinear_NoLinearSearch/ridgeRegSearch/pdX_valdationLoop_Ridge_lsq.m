function  [X_valdationErr,   gEstT, resnorm, FitT, useX, kFold ]=pdX_valdationLoop_Ridge_lsq( lambda1,kFold,M0,pBasis,g0,D,options,TruePD)
...
for ii=1:length(lambda1),
   ...
   [gEstT(:,:,jj,ii), resnorm(ii,jj)] = ...
       lsqnonlin(@(par) errFitRidgeNestBiLinear_lsq_v1(par,double(M0),...
       double(pBasis), Ncoils,D1,FitMask), ...
             double(g0),[],[],options);
