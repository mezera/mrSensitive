function [logname]=mrQ_PD_multicoil_RgXv_GridCall_Fittesting(outDir,subName,degrees,M0file,T1file,BMfile,outMm,boxSize,pracent_overlap,Coilsinfo,Reg,Init,clobber,Inclusion_Criteria,mrQ)
%
